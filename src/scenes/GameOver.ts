...
export class GameOver extends Container implements InterUpdateable{
    ...
    constructor() {
        ...
        this.background = new TilingSprite(Texture.from("GameOverBack"),WIDTH,HEIGHT);
        ...
        const menuTittle: Text = new Text("Larry is Dead, how tragic...", {fontSize: 60,align:'center', fill:0x000000, fontFamily: "Cambria"});
